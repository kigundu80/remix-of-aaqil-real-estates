...
const mockMessages = [
  {
    ...
    subject: "URGENT: Property Inquiry",
    message: "I need to speak with someone immediately about the property at Kampala Road. Please call me as soon as possible.",
    date: "2025-04-13T10:30:00",
    read: false,
    autoResponse: "Thank you for your urgent message! We prioritize all urgent inquiries and will contact you within the next hour.",
  },
  {
    id: "2",
    name: "Jane Smith",
    email: "jane@example.com",
    subject: "Important: Valuation Request",
    message: "I would like to request a valuation for my property in Entebbe. This is important for a potential sale next month.",
    date: "2025-04-12T16:45:00",
    read: true,
    autoResponse: "Thank you for your important message! Our team will get back to you within 24 hours.",
  },
  {
    id: "3",
    ...
    message: "I need advice regarding property ownership transfer procedures for my family estate.",
    date: "2025-04-11T09:15:00",
    read: false,
    autoResponse: "Thank you for your inquiry! Our legal team will review your message and contact you soon.",
  },
  {
    id: "4",
    name: "Sarah Williams",
    email: "sarah@example.com",
    subject: "General Property Question",
    message: "I'm interested in learning more about the properties in the Entebbe region. Do you have any brochures?",
    date: "2025-04-10T14:20:00",
    read: false,
    autoResponse: "Thank you for your interest! We'll send you information about our Entebbe properties shortly.",
  },
];
